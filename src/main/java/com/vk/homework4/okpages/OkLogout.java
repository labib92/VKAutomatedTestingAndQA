...
public class OkLogout extends OkBasePage {
    private static final By LOGOUT_LINK = By.xpath(".//a[@data-l='t,logout']");
    ...
    public void logoutSuccess() {
        ...
        $(LOGOUT_LINK).shouldBe(clickable
                .because("Logout hyperlink button should be clickable before we can click it")).click();
